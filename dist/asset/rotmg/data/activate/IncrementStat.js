...
exports.IncrementStat = void 0;
var Serializable_1 = require("../../../../asset/normal/Serializable");
var Stats_1 = require("../Stats");
var ActivateParser_1 = require("./ActivateParser");
var IncrementStat = /** @class */ (function () {
    function IncrementStat() {
        this.stats = new Stats_1.Stats();
    }
    IncrementStat.prototype.getName = function () {
        return "IncrementStat";
    };
    __decorate([
        (0, Serializable_1.Data)("", Stats_1.StatsData, { deserializeFullObject: true }),
        __metadata("design:type", Stats_1.Stats)
    ], IncrementStat.prototype, "stats", void 0);
    IncrementStat = __decorate([
